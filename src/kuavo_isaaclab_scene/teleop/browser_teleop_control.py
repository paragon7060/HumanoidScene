...
def compose_browser_action(mapped_action, gripper_action, body_action) -> np.ndarray:
    """Relative arms(12), head(2), active grippers(0..2), then body(7)."""
    ...
    if mapped.shape != (14,) or gripper.ndim != 1 or gripper.size > 2 or body.shape != (7,):
        raise ValueError("Browser actions require 14 arm/head, 0..2 gripper and 7 body values.")
