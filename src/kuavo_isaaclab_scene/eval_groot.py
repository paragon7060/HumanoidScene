...
parser.add_argument(
    "--initial-pose",
    choices=("default", "checkpoint-q50"),
    default=None,
    help=(
        "Robot reset pose. The RwH S56 profile defaults to the checkpoint's "
        "observation.state q50 arm pose with open claws."
    ),
)
parser.add_argument(
    "--camera-map",
...
from .eval_video import FfmpegVideoWriter, camera_mosaic_rgb, episode_video_path
