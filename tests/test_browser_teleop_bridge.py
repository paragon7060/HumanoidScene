...
def test_pose_editor_protocol_accepts_only_arm_joints_and_known_views():
    ...
    collision_model = parse_pose_editor_message(json.dumps({
        **base,
        ...
        "max_overshoot_m": 0.002,
        "margin_m": 0.004,
    }))
    assert collision_model is not None
    assert collision_model.collision_max_overshoot_m == pytest.approx(0.002)
    ...
    for invalid in (
        ...
        {**base, "action": "set_gripper_collision_model", "max_overshoot_m": 0.003, "margin_m": 0.004},
        {**base, "action": "set_gripper_collision_model", "max_overshoot_m": 0.002, "margin_m": 0.011},
        {**base, "action": "set_gripper_collision_model", "max_overshoot_m": "nan", "margin_m": 0.004},
